"""
Django settings for finerthings project.
...
SECRET_KEY = 'jpm)s2e38m-1jc#gyq4-=!_u=ro$%h*ew6l_v$+om%q8l7^u_2'
...
WSGI_APPLICATION = 'finerthings.wsgi.application'
